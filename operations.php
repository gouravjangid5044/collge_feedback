    ...
    >
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <center><a
            class="ml-5 text-lg font-bold text-gray-800 dark:text-gray-200"
            href="dashboard.php"
          >
            Admin
            <img src="https://manipaljaipur.in/main/wp-content/uploads/2021/01/67.png" alt="">
          </a></center>
          <ul class="mt-6">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            >
              ...
              <form action="assign_dep.php" method="POST">
              ...
              <div style="margin-top:5px">
                <button type="submit"
                  class="px-4 py-2 ext-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
                >
                  submit
                </button>
              </div>
            ...
            >
              Delete Department of User
            </h4>


              <form action="delete_dep.php" method="POST">
              <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">
                  Select Email ID
                </span>
            ...
            >
              ...
              <label class="block mt-4 text-sm">
                ...
                <input
                  ...
                  placeholder="Department name" required name="dept"
                />
              ...
              class="mb-2 text-lg font-semibold text-gray-600 dark:text-gray-300"
            >
              Remove Full Department
            </h4>


              <form action="remove_dep.php" method="POST">
              <label class="block mt-4 text-sm">
                <span class="text-gray-700 dark:text-gray-400">
                  Select Department
                </span>
            ...
            >
              ...
              <label class="block mt-4 text-sm">
                ...
                <input
                  class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                  placeholder="User email" required name="user" type="email"
                />
                <span class="text-xs text-gray-600 dark:text-gray-400">
                  Setting Password link will be sent on mail id provided 
                </span>
              </label>
              <div style="margin-top:5px">
                <button type="submit"
